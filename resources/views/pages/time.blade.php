                        ...
                        <form action="{{ route('routeGroupEventStore') }}" method="POST">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-sm-8">
                                    <input type="datetime-local" name="start" class="form-control date-times"  id="start" value="{{$time}}">
                                  </div>
                                </div>
                                <div class="form-group row">
                                  <label for="end" class="col-sm-4 col-form-label">End time</label>
                                  <div class="col-sm-8">
                                    <input type="datetime-local" name="end" class="form-control date-times" id="end" value="{{$time}}">
                                  </div>
                                </div>
                                <div class="form-group row">
